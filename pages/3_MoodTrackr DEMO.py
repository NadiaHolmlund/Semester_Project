...
col4.metric(label="Duration: " + str(grouped_df.iloc[6]['application_duration_min']) + ' min.', value=str(grouped_df.iloc[6]['application']), delta=str(grouped_df.iloc[6]['class_label']))
