...
col4.metric(label="Duration: " + str(grouped_df.iloc[4]['application_duration_min']) + ' min.', value=str(grouped_df.iloc[4]['application']), delta=str(grouped_df.iloc[4]['class_label']))
