...
col4.metric(label="Duration: " + str(grouped_df.iloc[5]['application_duration_min']) + ' min.', value=str(grouped_df.iloc[5]['application']), delta=str(grouped_df.iloc[5]['class_label']))
